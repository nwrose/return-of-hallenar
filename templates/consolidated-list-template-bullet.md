 ...
 * --------------------------
 */
const ITEM_PROPERTY_NAME = 'property'; // <--- CHANGE THIS to your property name (e.g., 'secondaryLocations')
const COLLECTED_ITEM_NAME_PLURAL = 'Properties'; // <--- CHANGE THIS to your desired output label (e.g., 'Locations')
